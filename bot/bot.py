...
class Bot:
    ...
    def log_message(self, message, key):
        self.logs[key].logger.debug(message)

    def log_to_main(self, message):
        self.log_message(message, Bot.MAIN_LOG)
    def log_to_error(self, message):
        self.log_message(message, Bot.ERROR_LOG)
